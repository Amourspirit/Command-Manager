...
namespace BigByteTechnologies.Library.Windows.CommandManagement
{
    ...
    public class ApplicationIdle : Component, IMessageFilter
    {
        ...
        /// <summary>
        /// Raised asynchronously on a separate thread when the IdleTime is reached.
        /// </summary>
        [Category("Behavior Async"),
        Description("Raised asynchronously on a separate thread when the IdleTime is reached.")]
        public event EventHandler IdleAsync;

        /// <summary>
        /// Raised asynchronously on a separate thread when the component is started.
        /// </summary>
        [Category("Behavior Async"),
        Description("Raised asynchronously on a separate thread when the component is started.")]
        public event EventHandler StartedAsync;

        /// <summary>
        /// Raised asynchronously on a separate thread when the component is paused.
        /// </summary>
        [Category("Behavior Async"),
        Description("Raised asynchronously on a separate thread when the component is paused.")]
        public event EventHandler PausedAsync;

        /// <summary>
        /// Raised asynchronously on a separate thread when the component is unpaused.
        /// </summary>
        [Category("Behavior Async"),
        Description("Raised asynchronously on a separate thread when the component is unpaused.")]
        public event EventHandler UnPausedAsync;

        /// <summary>
        /// Raised asynchronously on a separate thread when the component is stopped.
        /// </summary>
        [Category("Behavior Async"),
        Description("Raised asynchronously on a separate thread when the component is stopped.")]
        public event EventHandler StoppedAsync;

        /// <summary>
        /// Raised asynchronously on a separate thread when the component 'ticks'.
        /// </summary>
        [Category("Behavior Async"),
        Description("Raised asynchronously on a separate thread when the component 'ticks'.")]
        public event EventHandler<TickEventArgs> TickAsync;

        /// <summary>
        /// May be raised asynchronously on a separate thread when the WarnTime is reached and on each subsequent Tick depending on the WarnSetting.
        /// </summary>
        [Category("Behavior Async"),
        Description("May be raised asynchronously on a separate thread when the WarnTime is reached and on each subsequent Tick depending on the WarnSetting.")]
        public event EventHandler WarnAsync;

        /// <summary>
        /// Raised asynchronously on a separate thread when the component detects an activity that is defined in ActivityMessages.
        /// </summary>
        [Category("Behavior Async"),
        Description("Raised asynchronously on a separate thread when the component detects an activity that is defined in ActivityMessages.")]
        ...
        Category("Behavior"),
        DefaultValue(typeof(Behavior), "Stop"),
        Description("The Action Taken when Idle condition is met")]
        public Behavior IdleAction { get; set; }
